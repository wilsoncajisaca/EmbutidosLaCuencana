				...
				<div class="item-slick1 item1-slick1" style="background-image: url({{$slide-> imgFondo}});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="zoomIn">
							<!-- Button -->
							<a href="{{$slide-> url}}" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								Ver mas.
							</a>
						</div>
					</div>
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
										<img src="{{$masreciente-> portada}}" alt="IMG-PRODUCT">
						...
						<div class="row">
							...
							@foreach($masvendidos as $masvendido)
								...
								<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
									...
									<div class="block2">
										<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
											<img src="{{$masvendido-> portada}}" alt="IMG-PRODUCT">
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						...
						<div class="block3-txt p-t-14">
							...
							<span class="s-text6">Publicado </span> <span class="s-text7">@php $date = date_create($blog->fecha); echo date_format($date, 'M d, Y'); @endphp</span>
